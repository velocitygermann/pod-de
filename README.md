# Velocity German Podcast

Daily bilingual German/English podcast video at A2 level, generated automatically and uploaded to YouTube.

## Features
- 15-minute conversation between German hosts
...
2. `upload_to_youtube.py` - uploads the video + thumbnail to the Velocity German Podcast YouTube channel
